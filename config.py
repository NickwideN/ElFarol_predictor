...
# todo persent -> percent
# todo дублирование кода в Man.__init__() и Man.update()
...
# 1 - [ГРАФИК агент-предиктор РИСУЕТСЯ НЕПРАВИЛЬНО] слушаться мнения самого успешного в своем наборе предиктора. Если таких предикторов несколько, слушаться мнения большинства из самых успешных
...
# показать границу области состоящую из минимума и максимума за последние AREA_DAY_CNT дней (зеленая область на Графике посещаемости бара)
AREA_DAY_CNT = 20
